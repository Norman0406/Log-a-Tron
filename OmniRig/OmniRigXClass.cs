...
namespace OmniRig
{
    ...
    [ClassInterface(0)]
    [TypeLibType(2)]
    [ComSourceInterfaces("OmniRig.IOmniRigXEvents\0\0")]
    public class OmniRigXClass : IOmniRigX, OmniRigX, IOmniRigXEvents_Event
    {
        [DispId(1)]
        public virtual extern int InterfaceVersion
        {
        ...
        [DispId(2)]
        public virtual extern int SoftwareVersion
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(2)]
            get;
        ...
        [DispId(3)]
        public virtual extern RigX Rig1
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(3)]
        ...
        [DispId(4)]
        public virtual extern RigX Rig2
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(4)]
            [return: MarshalAs(UnmanagedType.Interface)]
        ...
        [DispId(5)]
        public virtual extern bool DialogVisible
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(5)]
            get;
