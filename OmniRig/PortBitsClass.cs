...
namespace OmniRig
{
    ...
    {
        [DispId(2)]
        public virtual extern bool Rts
        {
        ...
        [DispId(3)]
        public virtual extern bool Dtr
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(3)]
            get;
        ...
        [DispId(4)]
        public virtual extern bool Cts
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(4)]
            get;
        ...
        [DispId(5)]
        public virtual extern bool Dsr
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(5)]
            get;
        ...
        bool IPortBits.Lock()
        {
            //ILSpy generated this explicit interface implementation from .override directive in Lock
            return this.Lock();
        }
        ...
        void IPortBits.Unlock()
        {
            //ILSpy generated this explicit interface implementation from .override directive in Unlock
            this.Unlock();
        }
    }
}
