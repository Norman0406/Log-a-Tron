...
namespace OmniRig
{
    ...
    {
        [DispId(1)]
        public virtual extern string RigType
        {
        ...
        [DispId(2)]
        public virtual extern int ReadableParams
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(2)]
            get;
        ...
        [DispId(3)]
        public virtual extern int WriteableParams
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(3)]
            get;
        ...
        [DispId(6)]
        public virtual extern RigStatusX Status
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(6)]
            get;
        ...
        [DispId(7)]
        public virtual extern string StatusStr
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(7)]
            [return: MarshalAs(UnmanagedType.BStr)]
        ...
        [DispId(8)]
        public virtual extern int Freq
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(8)]
            get;
        ...
        [DispId(9)]
        public virtual extern int FreqA
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(9)]
            get;
        ...
        [DispId(10)]
        public virtual extern int FreqB
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(10)]
            get;
        ...
        [DispId(11)]
        public virtual extern int RitOffset
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(11)]
            get;
        ...
        [DispId(12)]
        public virtual extern int Pitch
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(12)]
            get;
        ...
        [DispId(13)]
        public virtual extern RigParamX Vfo
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(13)]
            get;
        ...
        [DispId(14)]
        public virtual extern RigParamX Split
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(14)]
            get;
        ...
        [DispId(15)]
        public virtual extern RigParamX Rit
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(15)]
            get;
        ...
        [DispId(16)]
        public virtual extern RigParamX Xit
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(16)]
            get;
        ...
        [DispId(17)]
        public virtual extern RigParamX Tx
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(17)]
            get;
        ...
        [DispId(18)]
        public virtual extern RigParamX Mode
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(18)]
            get;
        ...
        [DispId(26)]
        public virtual extern PortBits PortBits
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [DispId(26)]
        ...
        bool IRigX.IsParamReadable([In] RigParamX Param)
        {
            //ILSpy generated this explicit interface implementation from .override directive in IsParamReadable
            return this.IsParamReadable(Param);
        }
        ...
        bool IRigX.IsParamWriteable([In] RigParamX Param)
        {
            //ILSpy generated this explicit interface implementation from .override directive in IsParamWriteable
            return this.IsParamWriteable(Param);
        }
        ...
        void IRigX.ClearRit()
        {
            //ILSpy generated this explicit interface implementation from .override directive in ClearRit
            this.ClearRit();
        }
        ...
        void IRigX.SetSimplexMode([In] int Freq)
        {
            //ILSpy generated this explicit interface implementation from .override directive in SetSimplexMode
            this.SetSimplexMode(Freq);
        }
        ...
        void IRigX.SetSplitMode([In] int RxFreq, [In] int TxFreq)
        {
            //ILSpy generated this explicit interface implementation from .override directive in SetSplitMode
            this.SetSplitMode(RxFreq, TxFreq);
        }
        ...
        int IRigX.FrequencyOfTone([In] int Tone)
        {
            //ILSpy generated this explicit interface implementation from .override directive in FrequencyOfTone
            return this.FrequencyOfTone(Tone);
        }

        [MethodImpl(MethodImplOptions.InternalCall)]
        [DispId(23)]
        public virtual extern void SendCustomCommand([In][MarshalAs(UnmanagedType.Struct)] object Command, [In] int ReplyLength, [In][MarshalAs(UnmanagedType.Struct)] object ReplyEnd);

        void IRigX.SendCustomCommand([In][MarshalAs(UnmanagedType.Struct)] object Command, [In] int ReplyLength, [In][MarshalAs(UnmanagedType.Struct)] object ReplyEnd)
        {
            //ILSpy generated this explicit interface implementation from .override directive in SendCustomCommand
            this.SendCustomCommand(Command, ReplyLength, ReplyEnd);
        }
        ...
        int IRigX.GetRxFrequency()
        {
            //ILSpy generated this explicit interface implementation from .override directive in GetRxFrequency
            return this.GetRxFrequency();
        }
        ...
        int IRigX.GetTxFrequency()
        {
            //ILSpy generated this explicit interface implementation from .override directive in GetTxFrequency
            return this.GetTxFrequency();
        }
    }
}
