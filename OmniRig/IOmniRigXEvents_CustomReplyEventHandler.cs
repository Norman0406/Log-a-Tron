...
namespace OmniRig
{
    [TypeLibType(16)]
    [ComVisible(false)]
    public delegate void IOmniRigXEvents_CustomReplyEventHandler([In] int RigNumber, [In][MarshalAs(UnmanagedType.Struct)] object Command, [In][MarshalAs(UnmanagedType.Struct)] object Reply);
}
